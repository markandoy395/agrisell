          ...
          {filteredSales.map((sale) => {
            ...
            return (
              <article className="sale-promotion" key={sale.id}>
                ...
                <div className="sale-promotion-actions"><button type="button" onClick={() => edit(sale)}>Edit</button><button disabled={busySaleId === sale.id} type="button" onClick={() => void toggle(sale)}>{sale.isEnabled ? "Disable" : "Enable"}</button><button disabled={busySaleId === sale.id} type="button" onClick={() => void remove(sale)}>Remove</button></div>
              </article>
            );
          })}
